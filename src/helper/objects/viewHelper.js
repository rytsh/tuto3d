...
class ViewHelper extends THREE.Object3D {
  constructor( editorCamera, container, controls, clock = false ) {
    super();
    ...
    const clockT = clock ? new THREE.Clock() : undefined;
    ...
    this.update = function(delta = undefined) {
      if (!delta && clockT) {
        delta = clockT.getDelta();
      }
