...
// Load texture of fences
const fenceTexture = {
  color: textureLoader.load("assets/materials/objects/metalFence/Metal_Fence_001_basecolor.jpg"),
  ambientOcclusion: textureLoader.load("assets/materials/objects/metalFence/Metal_Fence_001_ambientOcclusion.jpg"),
  height: textureLoader.load("assets/materials/objects/metalFence/Metal_Fence_001_height.png"),
  normal: textureLoader.load("assets/materials/objects/metalFence/Metal_Fence_001_normal.jpg"),
  roughness: textureLoader.load("assets/materials/objects/metalFence/Metal_Fence_001_roughness.jpg"),
  metalness: textureLoader.load("assets/materials/objects/metalFence/Metal_Fence_001_metallic.jpg"),
  alpha: textureLoader.load("assets/materials/objects/metalFence/Metal_Fence_001_opacity.jpg"),
};

material.set("fence", new THREE.MeshStandardMaterial({
  ...
  metalnessMap: fenceTexture.metalness,
  displacementMap: fenceTexture.height,
  normalMap: fenceTexture.normal,
}));

Object.keys(fenceTexture).forEach((key) => {
  (fenceTexture[key] as THREE.Texture).wrapS = THREE.RepeatWrapping;
  (fenceTexture[key] as THREE.Texture).wrapT = THREE.RepeatWrapping;
  (fenceTexture[key] as THREE.Texture).repeat.setY(1);
  (fenceTexture[key] as THREE.Texture).repeat.setX(50);
});

// Add geometry and texture to plane
const fenceGeo = new THREE.PlaneGeometry(500, 10);

const fence = new THREE.Mesh(fenceGeo, material.get("fence"));
fence.position.setY(5);
group.add(fence);
